...
func init() {
	relatedFinders = map[string]func(*findContext){
		...
		"Deployment": func(fc *findContext) {
		...
		"StatefulSet": func(fc *findContext) {
		...
		"PersistentVolumeClaim": func(fc *findContext) {
		...
		"PersistentVolume": func(fc *findContext) {
		...
		"StorageClass": func(fc *findContext) {
...
func FindRelatedResources(
	...
	kind := k8s.GetKindByResourceType(resourceType)
	if finder, ok := relatedFinders[kind]; ok {
		finder(fc)
	}
	return fc.result
}
